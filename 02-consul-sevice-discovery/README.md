...
![service-discovery](terraform/Diagram.jpg)
...
Primarily you need to replace the key name `nholuong` to the pem key you have in your AWS account.
...
[all:vars]
ansible_user=ubuntu
ansible_private_key_file=/home/vagrant/.ssh/nholuong.pem
```
